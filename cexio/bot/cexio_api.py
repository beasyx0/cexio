# All credit to: https://github.com/fasetto/python-cexio/blob/master/cexio/__init__.py
# Had to import the code here to avoid namespace issues due to poor choice of project name.
import hmac
import hashlib
import time
import requests
...
class Api:
    ...
    def crypto_address(self, currency):
        '''
        :param currency: str (ex: BTC)
        :return: wallet addrss for crypto
        '''
